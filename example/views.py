...
def index(request):
    ...
    querystring = {"domain":"2", "province":"กรุงเทพมหานคร", "amphoe":"ลาดกระบัง", "tambon":"ลำปลาทิว", "fields":"tc,rh,cond", "starttime":"2023-09-" + day + "T" + time}
    ...
    <html>
        <body>
            ...
            <p>The tomorrow ({ day }) Weather condition is { display }.</p>
            <h2>T4E</h2>
        </body>
    </html>
    '''
